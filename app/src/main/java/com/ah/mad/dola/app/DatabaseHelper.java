package com.ah.mad.dola.app;
import com.ah.mad.dola.R;
...
class DbAdapter {
    ...
    // ✅ FUNGSI BARU YANG DITAMBAHKAN: Hapus Semua Server
    public final int deleteAllServers() {
        return db.delete(SERVER_TABLE, null, null);
    }
